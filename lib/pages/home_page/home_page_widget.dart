...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  Color getMedicationStatusColor(String status) {
    switch (status) {
      case 'completed':
        return Colors.green.shade500; // 복용완료 - 초록
      case 'missed':
        return Colors.red.shade500;   // 누락 - 빨강
      case 'today':
        return Colors.purple.shade500; // 오늘 - 보라
      case 'scheduled':
      default:
        return Colors.grey.shade400;  // 복용예정 - 회색
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      _buildMedicationDetailRow('타이레놀', status == 'completed' ? '08:00 복용' : '08:00 예정'),
                      if (status != 'scheduled') ...[
                        SizedBox(height: 8),
                        _buildMedicationDetailRow('게보린', status == 'completed' ? '20:00 복용' : '20:00 누락'),
                      ],
                    ],
                  ),
                ),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildLegendItem(Colors.green.shade500, '완료'),
              _buildLegendItem(Colors.red.shade500, '누락'),
              _buildLegendItem(Colors.purple.shade500, '오늘'),
              _buildLegendItem(Colors.grey.shade400, '예정'),
            ],
          ),
        ],
      ),
  ...
  void performSearch() {
    ...
    // SearchWidget으로 이동 (pilldata와 동일한 방식)
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SearchWidget(
          searchKeyword: searchKeyword,
          // 홈페이지에서는 약이름만 검색하므로 나머지는 null/빈 배열
          selectedShapes: null,
          selectedFormTypes: null,
          selectedColors: null,
          frontText: null,
          backText: null,
          isImageSearch: false, // 텍스트 검색임을 명시
        ),
      ),
    );
  }
                      ...
                      Padding(
                        ...
                        child: LayoutBuilder(
                          builder: (context, constraints) {
                            // 화면 크기에 따라 버튼 레이아웃 조정
                            double cardWidth = (constraints.maxWidth - 16) / 2;
                            double cardHeight = cardWidth * 0.9; // 가로세로 비율 조정
